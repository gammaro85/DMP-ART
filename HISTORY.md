...
- Bug: **Upload progress invisible** — `index.html` lacked the `#progress-container` markup the SSE progress logic expects — **Fix:** markup restored, matching existing CSS (`templates/index.html`, `static/css/style.css:2512`)
